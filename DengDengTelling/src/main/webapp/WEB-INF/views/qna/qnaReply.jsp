		...
		<div style="height: auto; padding-bottom: 5em;">
			<div align="center" class="container">
				<div align="left" style="width: 100%; border: 1px solid #cccccc; padding: 2em 5em; margin-top: 20px; margin-bottom: 1em; padding-bottom: 5em; background-color: #ffffff">
					<span style="font-weight: bold; font-size: 1.3em;">Q&A 답변쓰기</span>
					<hr />
					<div class="form-inline" style="margin-bottom: 1em">
						<label style="margin-right:100px;">말머리</label>
							<span style="position: relative; left: -5em">${map.QNA_HEADER}</span>
						<label style="margin-right:150px;">글제목</label>
							<span style="position: relative; left: -8em; color: #649EE1;">[답변] ${map.QNA_SUBJECT}</span>
					</div>
					<div class="form-inline" style="margin-bottom: 1em">
					...
					<div class="form-inline" style="margin-bottom: 1em">
						<label style="margin-right:100px;">질문내용</label>
							<span style="position: relative; left: -6em; color: #649EE1">[Q&A질문] ${map.QNA_CONTENT}</span>
					</div>
					<div class="textarea">
						<textarea rows="20" cols="100" title="내용" id="QNA_CONTENT" name="QNA_CONTENT" placeholder="질문의 답변을 입력하세요." style="resize: none;">${QNA_CONTENT }</textarea>
					</div>
					...
					<div style="position: relative; right: 65em; top:3em; padding-bottom: 5em;">
						<div style="float: left; position: relative;">
							<a href="#this" class="btn_style" id="addFile" >파일추가</a>
						</div>
						<div style="float: right; position: relative;">
							<a href="#this" class="btn_style" id="write" style="margin-right: 1em;">등록</a>	
