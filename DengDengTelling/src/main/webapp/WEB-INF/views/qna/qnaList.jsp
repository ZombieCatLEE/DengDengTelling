						...
						<tbody>
							<c:forEach var="row" items="${qnaList }">
								<tr>
									...
									<td class="QNA_WRITER" id="writer" style="text-align: center">${row.QNA_WRITER }</td>
									<td class="QNA_COUNT" style="text-align: center">${row.QNA_COUNT }</td>
									<td class="QNA_DATE" style="text-align: center">${row.QNA_DATE }</td>
								</tr>
							</c:forEach>
					 	...
					 	<div class="navBar">
							<div class="total" style="width: 70%; display: flex;" align="left">
								...
								<c:if test="${ID != null || ADMIN_ID == row.ADMIN_ID}">
									<div style="display: inline-flex; width: 28%; text-align: center;">
