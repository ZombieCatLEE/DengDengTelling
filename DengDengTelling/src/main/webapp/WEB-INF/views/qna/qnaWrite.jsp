		...
		<div style="height: auto;">
			<div align="center" class="container">
				<div align="left" style="width: 100%; border: 1px solid #cccccc; padding: 2em 5em; padding-bottom: 5em; margin-top: 20px; margin-bottom: 1em; background-color: #ffffff">
					<span style="font-weight: bold; font-size: 1.3em;">Q&A 글쓰기</span>
					<hr />
					...
					<div class="form-inline" style="margin-bottom: 1em">
						...
						<input type="hidden" name="BOARD_TYPE" id="BOARD_TYPE" value="${mem.BOARD_TYPE}"></input>
					...
					<div>
						<textarea rows="20" cols="100" title="내용" id="QNA_CONTENT" name="QNA_CONTENT" placeholder="내용을 입력하세요." style="resize: none;"></textarea>
					</div>
