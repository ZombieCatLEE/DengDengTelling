	...
	<div style="height: auto; min-height: 600px; border-top: solid;">
		<div style="height: auto;">
			<div align="center" class="container">
				<div align="left" style="width: 100%; border: 1px solid #cccccc; padding: 2em 5em; padding-bottom: 5em; margin-top: 20px; margin-bottom: 1em; background-color: #ffffff">
					<span style="font-weight: bold; font-size: 1.3em;">공지사항 글쓰기</span>
					<hr />
					<div class="form-inline" style="margin-bottom: 1em">
						<label style="width: 90px">글제목</label>
						<input type="text" id="NOTICE_SUBJECT" name="NOTICE_SUBJECT" value="${NOTICE_SUBJECT }"
							class="form-control" style="width: 500px" placeholder="글 제목을 입력하세요." />
					</div>
					<div class="form-inline" style="margin-bottom: 1em">
						<label style="width: 90px">작성자</label>
						<strong>${mem.ADMIN_NAME}</strong>
						<input type="hidden" name="NOTICE_WRITER" id="NOTICE_WRITER" value="${mem.ADMIN_NAME }"></input>
						<input type="hidden" name="BOARD_CREA_ID" id="BOARD_CREA_ID" value="${mem.ADMIN_ID }"></input>
						<input type="hidden" name="ADMIN_ID" id="ADMIN_ID" value="${mem.ADMIN_ID }"></input>
					</div>
					<div>
						<textarea rows="20" cols="100" title="내용" id="NOTICE_CONTENT" name="NOTICE_CONTENT" placeholder="내용을 입력하세요." style="resize: none;"></textarea>
					</div>
					
					<div class="table file">
						<h1 style="font-size: 1.1em; font-weight:bold; margin-top: 5px">
							<img src="resources/images/fileUpload.png" style="width: 2.5em;">첨부 파일</h1>
						...
						<div id="fileDiv" class="fileDiv">
							<p>
								<input type="file" id="file" class="file" name="file_0" /> 
					...
					<div style="top: 1em; display: flex;">
						...
						<div style="position: relative; display: inline-flex;">
							<a href="#this" class="btn_style" id="write" style="left: 55em; top: 0.1em;">등록</a>
							<a href="#this" class="btn_style" id="list" style="left: 56em; top: 0.1em;">취소</a>
						</div>
					</div>
				</div>
			</div>
