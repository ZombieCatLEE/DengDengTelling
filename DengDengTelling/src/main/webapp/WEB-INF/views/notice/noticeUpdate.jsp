		...
		<div align="center" class="container">
			<div align="left"
				style="width: 100%; height: auto; position: relative; border: 1px solid #cccccc; padding: 2em; margin-top: 20px; padding-bottom: 5em; margin-bottom: 3em; background-color: #ffffff">
					...
					<div>
						<textarea rows="20" cols="100" title="내용" id="NOTICE_CONTENT" name="NOTICE_CONTENT" placeholder="내용을 입력하세요." style="resize: none;">${map.NOTICE_CONTENT}</textarea>
					</div>
				...
				<div style="position: relative; top: -2em;">
					<div style="float: left; position: relative; right: 30em;">
						<a href="#this" class="btn_style" id="addFile">파일추가</a>
					</div>
					<div style="float: right; position: relative; right: 34.5em;">
			...
			var gfv_count = '${fn:length(list)+1}';
				...
				function fn_updateBoard(){
					...
					if(confirm("수정 하시겠습니까?") == true) {
						comSubmit.setUrl("<c:url value='/noticeUpdate' />"); 
						comSubmit.submit();
					} else {
						return;
					}
				...
				function fn_addFile(){ 
					var str = "<div class='div'>" + "<input type='file' id='file_" + (gfv_count)
							+ "' name='file_" + (gfv_count)
							+ "' style='width: 200px; float:left;'> <a href='#this' class='btn' id='delete_" + (gfv_count)
							+ "' name='delete_" + (gfv_count) + "'>삭제</a>" 
							+ "</div>"; 
					$("#fileDiv").append(str); 
