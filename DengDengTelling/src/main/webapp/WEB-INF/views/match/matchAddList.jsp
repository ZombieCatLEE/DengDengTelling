			...
			<div id="ttr_content_and_sidebar_container">
				<div id="ttr_content">
					<div id="ttr_content_margin" class="container-fluid" style="">
						...
						<!-- 첫번째 펫시터 상세내용 -->
						<c:forEach var="list" items="${addList}">	<!-- 이 부분에 디테일 링크 어디에 걸지 생각해보자. 링크는 get 방식으로 넘겨서 이동하는 걸로. detail method 그대로 사용 -->
								...
								<div class="post_column col-lg-4 col-md-4 col-sm-4 col-xs-12">
									<div class="ttr_Training_html_column10">
										...
										<div class="html_content" style="position:relative; right:5em;">
											<p>
												<span style="float: none; display: block; text-align: center; overflow: hidden; margin: 0em 0em 0em 0em; cursor: pointer;" onclick="location.href='matchDetailGo?seq=${list.MATCH_NO}&&ID=${list.ID}'">
													<span><img src="resources/downimage/<c:out value='${list.IMAGE}'/>" style="max-width: 300px; max-height: 300px;"/></span></span>
											</p>
										</div>
										<div style="height: 0px; width: 0px; overflow: hidden; -webkit-margin-top-collapse: separate;"></div>
								...
								<div class="post_column col-lg-8 col-md-8 col-sm-8 col-xs-12">
									<div class="ttr_Training_html_column11">
										...
										<div class="html_content" style="position:relative; right:5em; margin-top: 15px;">
											<div style="position: relative; align-items: center; text-align: center; vertical-align: middle; width: 30em;">
												<p>
													<span style="font-family: 'Arial'; font-weight: 700; font-size: 1.143em; color: #6E6E6E; position: relative;">
														<c:out value="${list.ADDRESS}"/></span>
												</p>
												<p style="margin: 1em 0em 1em 0em;">
														<span style="font-family: 'Arial'; font-weight: bold; font-size: 2em; color: #2E2E2E; cursor: pointer;" onclick="location.href='matchDetailGo?seq=${list.MATCH_NO}&&ID=${list.ID}'">
															<c:out value="${list.SUBJECT}"/></span>
												</p>
												<p style="margin: 0.71em 0em 0.36em 0em;">
														<span style="font-family: 'Arial'; font-weight: bold; font-size: 1.5em; color: #2E2E2E;">
															<c:out value="${list.CLASS}"/>&nbsp;펫시터&nbsp;<c:out value="${list.NAME}"/>&nbsp;님</span>
												</p>
							...
							<div style="position: relative; left:8em; bottom: 8em;">
								<p style="margin-top: 10px; margin-bottom:5px; text-align: right">
									<b>대형견</b> : &nbsp;<span style="font-size: 1.2em; font-weight: bold; color: #084B8A;"><c:out value="${list.LARGE_ALL}"/></span>&nbsp;/&nbsp;맡김&nbsp;&nbsp;|&nbsp;&nbsp;
									<span style="font-size: 1.2em; font-weight: bold; color: #084B8A;"><c:out value="${list.LARGE_HALF}"/></span>&nbsp;/&nbsp;돌봄
								</p>
								<p style="margin-top: 10px; margin-bottom:5px; text-align: right">
									<b>중형견</b> : &nbsp;<span style="font-size: 1.2em; font-weight: bold; color: #084B8A;"><c:out value="${list.MEDIUM_ALL}"/></span>&nbsp;/&nbsp;맡김&nbsp;&nbsp;|&nbsp;&nbsp;
									<span style="font-size: 1.2em; font-weight: bold; color: #084B8A;"><c:out value="${list.MEDIUM_ALL}"/></span>&nbsp;/&nbsp;돌봄
								</p>
								<p style="margin-top: 10px; margin-bottom:5px; text-align: right">
									<b>소형견</b> : &nbsp;<span style="font-size: 1.2em; font-weight: bold; color: #084B8A;"><c:out value="${list.SMALL_ALL}"/></span>&nbsp;/&nbsp;맡김&nbsp;&nbsp;|&nbsp;&nbsp;
									<span style="font-size: 1.2em; font-weight: bold; color: #084B8A;"><c:out value="${list.SMALL_ALL}"/></span>&nbsp;/&nbsp;돌봄
								</p>
							</div>
						</c:forEach>
						<div
