		...
		<div style="height: auto;">
			<div align="center" class="container">
				<div align="left" style="width: 100%; border: 1px solid #cccccc; padding: 2em 5em; padding-bottom: 5em; margin-top: 20px; margin-bottom: 1em; background-color: #ffffff">
					<span style="font-weight: bold; font-size: 1.3em;">댕댕이 자랑 글쓰기</span>
					<hr />
					<div class="form-inline" style="margin-bottom: 1em">
						<label style="width: 90px">글제목</label> 
						<input type="text" id="MYPET_SUBJECT" name="MYPET_SUBJECT" value="${MYPET_SUBJECT}" class="form-control" style="width: 500px"
					...
					<div class="form-inline" style="margin-bottom: 1em;">					
						...
						<input type="hidden" name="MAIN_IMG" id="MAIN_IMG" value="${map.MAIN_IMG }"></input>
					</div>
					<div>
						<textarea rows="20" cols="100" title="내용" id="MYPET_CONTENT" name="MYPET_CONTENT" placeholder="내용을 입력해 주세요." style="resize: none;"></textarea>
					</div>
