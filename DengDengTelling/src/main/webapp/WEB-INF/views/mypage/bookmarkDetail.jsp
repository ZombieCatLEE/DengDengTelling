		...
		<c:forEach var="pstIMG" items="${pstImg}" varStatus="status">
 		...
 		<div style="display: flex; flex-direction: row; margin-top: 10px; float: right; position: relative; left: -50%; clear: both;">
  			<c:forEach var="petIMAGE" items="${pstImg}" varStatus="status">
				<div style="display: flex; flex-direction: column; float: left; position: relative; left: 50%;">
	...
	<div style="margin-top: 73px; margin-left: auto; margin-right: auto; width: 1027px; display: flex; flex-direction: row; justify-content: space-between">
					...
					<c:forEach var="service" items="${serviceList}">
						<c:if test="${service == 'service01'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								...
								<img width="32" height="32" src="resources/images/service01.png"></div>
						...
						<c:if test="${service == 'service02'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service02.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>픽업</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service03'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service03.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>대형견</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service04'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service04.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>마당 있음</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service05'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service05.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>노견 케어</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service06'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service06.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>장기 예약</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service07'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service07.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>실내 놀이</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service08'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service08.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>매일 산책</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service09'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service09.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>목욕 가능</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service10'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service10.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>약물 경구 복용</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service11'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service11.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>강아지 케어</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service12'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner;  margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service12.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>아파트</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service13'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service13.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>빌라</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service14'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service14.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>단독 주택</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service15'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service15.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>싱글</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service16'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service16.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>아이 없음</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
						...
						<c:if test="${service == 'service17'}">
							<div style="display: block; width: 200px; height: 69px; float: left; position: relative; text-align: cetner;">
								<div style="display: inline-block; float: left; position: relative; text-align: cetner; margin-left: 30px;">
								<img width="32" height="32" src="resources/images/service17.png"></div>
								<div style="display: inline-block; margin-left: 13px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85);">
										<b>반려동물 등록 가능</b></p>
									<p style="font-size: 11px; letter-spacing: -0.2px; line-height: 11px; color: rgb(94, 99, 109); margin-top: 5px;">
		...
		<div style="float: left; width: 30%; margin-top: 50px;">
			...
			<div style="width: 375px; border-radius: 8px; border: 1px solid #DFE3EA; box-shadow: 1px 3px 7px rgba(0, 0, 0, 0.07); padding-left: 32px; padding-right: 32px; padding-bottom: 32px">
				...
				<div style="display: flex; flex-grow: 1; margin-top: 1em">
					<form method="get" class="tm-search-form tm-section-pad-2">
						<div class="form-group tm-form-element tm-form-element-50" style="width: 22em; bottom: 1em" align="center">
							<i class="fa fa-calendar fa-2x tm-form-element-icon"></i>
							<input name="basicDate" type="text" class="flatpickr-input" id="basicDate" placeholder="예약 날짜 선택" style="font-size: 1em; width: 18em; line-height: 1.3em;">
						</div>
					</form>
				</div>
			...
			<div style="position: relative; line-height: 1em; display: flex; flex-direction: column; width: 375px; height: 400px; border-radius: 8px; border: 1px solid #DFE3EA; box-shadow: 1px 3px 7px rgba(0, 0, 0, 0.07); margin-top: 38px; overflow: hidden; text-align: center;">
				<h2 style="font-weight: 600; font-size: 17px; letter-spacing: -0.2px; line-height: 25px; color: #393C47; margin-bottom: 8px; margin-top: 1.3em;">${name} 펫시터님의 동네 위치입니다.</h2>
			...
			<c:choose>
				<c:when test="${MEM_TYPE == '일반 회원'}">
					<div style="width: 375px; border-radius: 8px; border: 1px solid #DFE3EA; box-shadow: 1px 3px 7px rgba(0, 0, 0, 0.07); margin-top: 40px; text-align: center; vertical-align: middle; align-items: center; position: relative;">
						<div style="text-align: center; position: relative; vertical-align: middle;">
							<button type="button" style="height: 2.5em; width: 10em; font-size: 1.2em; font: bold; background-color: #037FBB; border: none; color:#fff; cursor: pointer; border-radius: 10px; margin-top: 1em; margin-bottom: 1em;" name="petsittingReserveBt" id="petsittingReserveBt" onclick="pstInsert()">예약하기</button>
						</div>
					</div>
				</c:when>
			</c:choose>
