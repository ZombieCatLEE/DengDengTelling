...
<form id="petsittingDetail" name="petsittingDetail" method="post">
	...
	<div style="margin-top: 5px; margin-left: auto; margin-right: auto; width: 1027px; display: flex; flex-direction: row; justify-content: space-between">
		<div style="float: left; width: 66%; padding: 20px;">
			...
			<!-- 윗단은 멤버 프로필 사진 --> <!-- 프로필 사진도 가져와야 함 -->
				...
				<div style="overflow: hidden; width: 430px;">
					...
					<c:choose>
						<c:when test="${MEM_TYPE == '펫시터' || MEM_TYPE == '관리자'}">
							<div>
								<p style="font-family: Noto Sans KR, sans-serif; font-size: 14px; color: #585858; line-height: 20px; letter-spacing: -0.2px;">
									<img width="14px" height="14px" style="object-fit: cover; margin-right: 5px; position: relative; top: 2px;" src="resources/images/check.png" />연락처 : ${pstDetail.P_MOBILE}
								</p>
							<div>
							</div>
								<p style="font-family: Noto Sans KR, sans-serif; font-size: 14px; color: #585858; line-height: 20px; letter-spacing: -0.2px;">
									<img width="14px" height="14px" style="object-fit: cover; margin-right: 5px; position: relative; top: 2px;" src="resources/images/check.png" />이메일 : ${pstDetail.P_EMAIL}
								</p>
							</div>
						</c:when>
						<c:otherwise>
			...
			<div style="display: flex; flex-direction: row"> <!-- 다음에 수정할 때는 이 지랄하지 말고 테이블에 넣어서 반복 돌려야지... 이건 미친 짓이다. -->
				<div> <!-- 서비스 부분은 컨트롤러에서 스플릿 해서 배열로 담아오자. 그 다음 반복문으로 꺼내면서 조건문을 포함해서 나오도록. -->
					...
					<h2 style="font-weight: 600; font-size: 17px; letter-spacing: 1px; margin-bottom: 15px; line-height: 25px; color: #393C47">
						<img width="17px" height="17px" style="object-fit: cover; display: inline-block; margin-right: 5px; position: relative; top: 3px;" src="resources/images/check.png"> 위탁 장소 주소</h2>
					</div>
					<c:choose>
						<c:when test="${MEM_TYPE == '펫시터'}">
								<div style="display: block; width: auto; height: 25px; float: left; position: relative; text-align: cetner;">
									<div style="display: inline-block; margin-left: 35px; position: relative; width: 150;">
										<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 15px; letter-spacing: -0.2px; line-height: 13px; color: #084B8A; position: relative; top: -10px;">
			...
			<div style="display: flex; flex-direction: row"> <!-- 다음에 수정할 때는 이 지랄하지 말고 테이블에 넣어서 반복 돌려야지... 이건 미친 짓이다. -->
				<div> <!-- 서비스 부분은 컨트롤러에서 스플릿 해서 배열로 담아오자. 그 다음 반복문으로 꺼내면서 조건문을 포함해서 나오도록. -->
					<div style="display: flex; margin-top: 5px; width: 600px; position: relative; text-align: center;">
					<h2 style="font-weight: 600; font-size: 17px; letter-spacing: 1px; margin-bottom: 15px; line-height: 25px; color: #393C47">
						<img width="17px" height="17px" style="object-fit: cover; display: inline-block; margin-right: 5px; position: relative; top: 3px;" src="resources/images/check.png"> 상세 조건</h2>
					</div>
						...
						<c:if test="${service == 'service01'}">
							<div style="display: block; width: 200px; height: 25px; float: left; position: relative; text-align: cetner;">
								...
								<div style="display: inline-block; margin-left: 7px; position: relative; width: 150;">
									<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 13px; color: rgb(85, 85, 85); position: relative; top: -10px;">
										<b>현재 반려동물 없음</b></p>
								</div>
							</div>
						</c:if>
			...
			<div style="margin-top: 30px">
				<h2 style="font-weight: 600; font-size: 17px; letter-spacing: 1px; margin-bottom: 15px; line-height: 25px; color: #393C47">
						<img width="17px" height="17px" style="object-fit: cover; display: inline-block; margin-right: 5px; position: relative; top: 3px;" src="resources/images/check.png"> 자격증 및 교육 수료</h2>
					...
					<div style="display: block; margin-left: 18px;">
						<c:forEach var="certi" items="${certi}" varStatus="status">
							...
							<div style="display: inline-block; width: 42%; position: relative; text-align: left; vertical-align: middle; align-items: left;">
								<span style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 13px; letter-spacing: -0.2px; line-height: 27px; color: rgb(85, 85, 85); position: relative; top: -5px;">
			...
			<div style="margin-top: 30px;">
				<h2 style="font-weight: 600; font-size: 17px; letter-spacing: 1px; line-height: 25px; color: #393C47; margin-bottom: 20px">
					<img width="17px" height="17px" style="object-fit: cover; display: inline-block; margin-right: 5px; position: relative; top: 3px;" src="resources/images/check.png"> 반려동물</h2>
			...
			<!-- 윗단은 멤버 프로필 사진 --> <!-- 프로필 사진도 가져와야 함 -->
				...
				<div style="overflow: hidden; width: 430px;">
					...
					<c:choose>
						<c:when test="${MEM_TYPE == '일반 회원' || MEM_TYPE == '관리자'}" >
							<div>
								<p style="font-family: Noto Sans KR, sans-serif; font-size: 14px; color: #585858; line-height: 20px; letter-spacing: -0.2px;">
									<img width="14px" height="14px" style="object-fit: cover; margin-right: 5px; position: relative; top: 2px;" src="resources/images/check.png" />연락처 : ${pstDetail.M_MOBILE}
								</p>
							<div>
							</div>
								<p style="font-family: Noto Sans KR, sans-serif; font-size: 14px; color: #585858; line-height: 20px; letter-spacing: -0.2px;">
									<img width="14px" height="14px" style="object-fit: cover; margin-right: 5px; position: relative; top: 2px;" src="resources/images/check.png" />이메일 : ${pstDetail.M_EMAIL}
								</p>
							</div>
						</c:when>
						<c:otherwise>
				...
				<div>
					<div style="display: flex; margin-top: 5px; width: 600px; position: relative; text-align: center;">
						<h2 style="font-weight: 600; font-size: 17px; letter-spacing: 1px; line-height: 25px; color: #393C47; margin-bottom: 10px">
							<img width="17px" height="17px" style="object-fit: cover; display: inline-block; margin-right: 5px; position: relative; top: 3px;" src="resources/images/check.png"> 거주지 주소</h2>
					</div>
					<c:choose>
		...
		<div style="float: left; width: 30%;">
			<!-- 펫시터 예약 날짜 선택 -->
			<div style="width: 375px; border-radius: 8px; border: 1px solid #DFE3EA; box-shadow: 1px 3px 7px rgba(0, 0, 0, 0.07); margin-right: 32px; margin-bottom: 32px; margin-top: 50px;">
				<p style="font-size: 17px; letter-spacing: -0.2px; line-height: 25px; color: #393C47; margin-top: 38px; margin-bottom: 5px; font-weight: 600; padding-left: 32px;">
					예약 날짜
				</p>
				<div style="width: auto; display: flex; flex-direction: column; justify-content: space-between; margin-top: 30px; margin-bottom: 8px; position: relative; padding-right: 32px; padding-left: 32px;">
				...
				<div style="border: dotted 1px; display: flex; flex-direction: row; justify-content: space-between; margin-top: 10px; margin-bottom: 10px; margin-left: 10px; margin-right: 10px; padding: 3px; border-radius: 15px; border-color: #A4A4A4; text-align: center;">
			...
			<div style="position: relative; width: 375px; border-radius: 8px; border: 1px solid #DFE3EA; box-shadow: 1px 3px 7px rgba(0, 0, 0, 0.07); margin-top: 38px">
				<div style="display: flex; flex-direction: row; align-items: center; justify-content: space-between">
					<p style="font-size: 17px; font-weight: 600; letter-spacing: -0.2px; line-height: 25px; color: #393C47; margin-left: 32px; margin-top: 38px;">이용 요금</p>
					<div style="display: flex; align-items: center; flex-direction: row; margin-top: 25px; margin-right: 32px;">
				...
				<div style="width: 315px; margin-left: 30px; margin-right: 30px; height: 1px; background-color: #EBEBEB; margin-top: 10px; margin-bottom: 30px"></div>
				<div style="display: flex; flex-direction: row; align-items: center; justify-content: space-between; margin-top: 14px">
					<div style="display: flex; flex-direction: row; align-items: center; height: 24px; margin-left: 32px;">
				...
				<div style="display: flex; flex-direction: row; align-items: center; justify-content: space-between; margin-top: 14px; margin-bottom: 20px;">
					<div style="display: flex; flex-direction: row; align-items: center; height: 24px; margin-left: 32px;">
			...
			<div style="position: relative; line-height: 1em; display: flex; flex-direction: column; width: 375px; height: 400px; border-radius: 8px; border: 1px solid #DFE3EA; box-shadow: 1px 3px 7px rgba(0, 0, 0, 0.07); margin-top: 38px; overflow: hidden; text-align: center;">
				...
				<c:if test="${MEM_TYPE == '펫시터' || MEM_TYPE == '관리자'}" >
					<c:choose>
						<c:when test="${pstDetail.PROGRESS_STEPS == 1 || pstDetail.PROGRESS_STEPS == 2}" >
				...
				<div id="map" style="position: absolute; height: 300px; border-radius: 4px; border: 1px solid #DFE3EA; overflow: hidden; display: inline-block; text-align: center; top: 23%; left: 52.5%; width: 95%; margin-top: -0.5em; margin-left: -50%;">
					...
					<script>
						...
						var address;
						if(form.type.value == '일반 회원') {
							if(form.step.value == 1 || form.step.value == 2) {
								address = form.P_ADD1.value
							} else {
								address = form.P_ADD1.value + ' ' + form.P_ADD2.value
							}	
						} else if(form.type.value == '펫시터' || form.type.value == '관리자') {
							if(form.step.value == 1 || form.step.value == 2) {
								address = form.M_ADD1.value
							} else {
								address = form.M_ADD1.value + ' ' + form.M_ADD2.value
							}
						}
						...
						//geocoder.addressSearch('경기도 의정부시 용민로 21', function(result, status) { //확인용
							...
							if (status === kakao.maps.services.Status.OK) {
								...
								var infowindow = new kakao.maps.InfoWindow({
									content : '<div style="width:150px;text-align:center;padding:3px 0;">세부 위치</div>'
								});
			...
			<div style="width: 375px; border-radius: 8px; border: 1px solid #DFE3EA; box-shadow: 1px 3px 7px rgba(0, 0, 0, 0.07); padding-bottom: 32px; margin-top: 40px; text-align: center; vertical-align: middle; align-items: center; position: relative;">
				<c:choose>
							...
							<c:if test="${MEM_TYPE == '일반 회원'}">
								<c:if test="${firstDay - nowDay > 0}">
									...
									<div style="display: block; width: auto; position: relative; text-align: center; vertical-align: middle;">
										<div style="display: inline-block; height: auto; width: auto; text-align: center; position: relative; vertical-align: middle;">
											<div style="height: 30px; width: auto; margin-top: 30px; margin-left: 10px; text-align: center; position: relative; vertical-align: middle;">
												<h4>약속일까지 <b>${diffDay}일</b> 남았습니다.</h4>
											</div>
										</div>
									</div>
								</c:if>
									...
									<div style="display: block; width: auto; position: relative; text-align: center; vertical-align: middle;">
										<div style="display: inline-block; height: auto; width: auto; text-align: center; position: relative; vertical-align: middle;">
											<div style="height: 30px; width: auto; margin-top: 15px; margin-left: 10px; text-align: center; position: relative; vertical-align: middle;">
												<h4 style="margin-top: -10px;">댕댕이와 만나셨다면</h4>
												<h4 style="margin-top: -10px; margin-bottom: 5px;">펫시팅 종료 버튼을 눌러주세요.</h4>
											</div>
										</div>
									</div>
									<div style="display: block; width: auto; position: relative; text-align: center; vertical-align: middle;">
						...
						<c:if test="${pstDetail.PROGRESS_STEPS == 4}">
							<c:if test="${MEM_TYPE == '일반 회원'}">
								...
								<div style="display: block; width: auto; position: relative; text-align: center; vertical-align: middle;">
									<div style="display: inline-block; height: auto; width: auto; text-align: center; position: relative; vertical-align: middle;">
										<div style="height: 30px; width: auto; margin-top: 15px; margin-left: 10px; text-align: center; position: relative; vertical-align: middle;">
											<h4 style="margin-top: -10px;">회원님이 남기신 후기는</h4>
											<h4 style="margin-top: -10px; margin-bottom: 10px;">펫시터와 댕댕텔링에게 큰 도움이 됩니다.</h4>
										</div>
									</div>
								</div>
								<div style="display: block; width: auto; position: relative; text-align: center; vertical-align: middle;">
									<div style="display: inline-block; height: auto; width: auto; text-align: center; position: relative; vertical-align: middle;">
										<div style="height: 30px; width: auto; margin-top: 35px; margin-left: 10px; margin-right: 10px; margin-bottom: 10px; text-align: center; position: relative; vertical-align: middle;">
											<button type="button" style="height: 50px; width: 130px; font-size: 18px; font: bold; background-color: #037FBB; border: none; color:#fff; cursor: pointer; border-radius: 10px;" name="petsittingUpdateBt" id="petsittingUpdateBt" value="5" onclick="pstUpdate()">후기 등록하기</button>
										</div>
									</div>
								</div>
			...
			<!-- 닫기 버튼 -->
			<div style="position: relative; width: 375px; border-radius: 8px; border: 1px solid #DFE3EA; box-shadow: 1px 3px 7px rgba(0, 0, 0, 0.07); margin-top: 38px">
				<div align="center" style="padding-top: 3em; padding-bottom: 3em;">
					<Button type="button" class="my_button" style="font-size: 1.1em; width: 15em;" onclick="window.close();">닫&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;기</Button>				
				</div>
			</div>
		</div>
	</div>
