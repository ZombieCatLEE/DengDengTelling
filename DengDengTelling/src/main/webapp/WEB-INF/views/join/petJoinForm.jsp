...
<script type="text/javascript">
	function petJoinSave() {
		...
		if (!chk) {
			alert("성별을 체크해주세요.")
			$("#PET_MEM_SEX1").focus();	//체크 박스, 라디오 버튼 포커스 안 먹음
			return false;
		}
		if (!$("#PET_MEM_KIND").val()) {
			alert("견종을 입력해주세요.");
	...
	<table style="position: relative; width: 100%;">
		...
		<tr style="height: 5em;">
			...
			<td style="width: 38%; font-size: 1.1em;"><label
				style="margin-right: 3em;"> <input type="radio"
					name="PET_MEM_SEX" id="PET_MEM_SEX1" value="M" style="position: relative;">
					남아
			</label> <label> <input type="radio" name="PET_MEM_SEX" id="PET_MEM_SEX2" value="F"
					style="position: relative;"> 여아
			</label></td>
		...
		<tr style="height: 3em;">
			...
			<td style="width: 38%; font-size: 1.1em;"><input type="text"
				...
				<button type="button" class="my_button"
					...
					onclick="window.open('petSearch', 'window', 'width=600px, height=500px, scrollbars=yes')">견종
					검색</button></td>
		...
		<tr style="height: 3em;">
			...
			<td style="width: 38%; font-size: 1.1em;">
				<input type="text" name="PET_MEM_WEIGHT" id="PET_MEM_WEIGHT" style="width: 3em; line-height: 1.5em; font-size: 1.1em; border-radius: 0.5em;"/><b>&nbsp;Kg</b>
			</td>
			<td style="width: 40%; text-align: center;"></td>
		</tr>
		<tr style="height: 3em;">
		...
		<tr style="height: 5em;">
			...
			<td style="width: 38%; font-size: 1.1em;">
				<label style="margin-right: 3em;"> 
					<input type="radio" name="PET_MEM_SEX_CHECK" id="PET_MEM_SEX_CHECK1" value="Y" style="position: relative;">
						예&nbsp;&nbsp;&nbsp;&nbsp;
				</label> 
				<label> 
					<input type="radio" name="PET_MEM_SEX_CHECK" id="PET_MEM_SEX_CHECK2" value="N" style="position: relative;">
						아니오
				</label>
			</td>
			<td style="width: 40%; text-align: center;"></td>
		...
		<tr style="height: 5em;">
			...
			<td style="width: 38%; font-size: 1.1em;"><label
				style="margin-right: 3em;"> <input type="radio"
					name="PET_MEM_CASE" id="PET_MEM_CASE1" value="Y" style="position: relative;">
					유&nbsp;&nbsp;&nbsp;&nbsp;
			</label> <label> <input type="radio" name="PET_MEM_CASE" value="N" id="PET_MEM_CASE2"
					style="position: relative;"> 무
			</label></td>
			<td style="width: 40%; text-align: center;"></td>
		</tr>
...
<div style="height: auto;">
	...
	<div align="center">
		<table
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_RESPONSE" id="PET_MEMBER_ADD_RESPONSE1"
					value="1" /></th>
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_RESPONSE" id="PET_MEMBER_ADD_RESPONSE2"
					value="2" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_RESPONSE" id="PET_MEMBER_ADD_RESPONSE3"
					value="3" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_RESPONSE" id="PET_MEMBER_ADD_RESPONSE4"
					value="4" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
		...
		<table
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_HUMAN" id="PET_MEMBER_ADD_HUMAN1" value="1" />
				</th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_HUMAN" id="PET_MEMBER_ADD_HUMAN2" value="2" />
				</th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_HUMAN" id="PET_MEMBER_ADD_HUMAN3" value="3" />
				</th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_HUMAN" id="PET_MEMBER_ADD_HUMAN4" value="4" />
				</th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
		...
		<table
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_BARK" id="PET_MEMBER_ADD_BARK1" value="1" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
					for="PET_MEMBER_ADD_BARK1">짖음이 거의 없어요.</label></th>
			</tr>
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_BARK" id="PET_MEMBER_ADD_BARK2" value="2" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
					for="PET_MEMBER_ADD_BARK2">외부 소음 및 낯선 사람을 볼 때 짖어요.</label></th>
			</tr>
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_BARK" id="PET_MEMBER_ADD_BARK3" value="3" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
		...
		<table
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_TRAINING" id="PET_MEMBER_ADD_TRAINING1"
					value="1" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_TRAINING" id="PET_MEMBER_ADD_TRAINING2"
					value="2" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
		...
		<table
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_DDONG_STYLE" id="PET_MEMBER_ADD_DDONG_STYLE1"
					value="1" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
					for="PET_MEMBER_ADD_DDONG_STYLE1">배변패드 및 지정된 장소에서 볼 일을 봐요.</label>
				</th>
			</tr>
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_DDONG_STYLE" id="PET_MEMBER_ADD_DDONG_STYLE2"
					value="2" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_DDONG_STYLE" id="PET_MEMBER_ADD_DDONG_STYLE3"
					value="3" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
		...
		<table
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_SHARP_BODY" id="PET_MEMBER_ADD_SHARP_BODY1"
					value="1" /></th>
				<th style="font-size: 1.1em; padding: 0.3em; width: 8em;"><label
					for="PET_MEMBER_ADD_SHARP_BODY1">가슴</label></th>

				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_SHARP_BODY" id="PET_MEMBER_ADD_SHARP_BODY2"
					value="2" /></th>
				<th style="font-size: 1.1em; padding: 0.3em; width: 8em;"><label
					for="PET_MEMBER_ADD_SHARP_BODY2">얼굴</label></th>

				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_SHARP_BODY" id="PET_MEMBER_ADD_SHARP_BODY3"
					value="3" /></th>
				<th style="font-size: 1.1em; padding: 0.3em; width: 8em;"><label
					for="PET_MEMBER_ADD_SHARP_BODY3">등</label></th>

				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_SHARP_BODY" id="PET_MEMBER_ADD_SHARP_BODY4"
					value="4" /></th>
				<th style="font-size: 1.1em; padding: 0.3em; width: 8em;"><label
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_SHARP_BODY" id="PET_MEMBER_ADD_SHARP_BODY5"
					value="5" /></th>
				<th style="font-size: 1.1em; padding: 0.3em; width: 8em;"><label
					for="PET_MEMBER_ADD_SHARP_BODY5">꼬리</label></th>

				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_SHARP_BODY" id="PET_MEMBER_ADD_SHARP_BODY6"
					value="6" /></th>
				<th style="font-size: 1.1em; padding: 0.3em; width: 8em;"><label
					for="PET_MEMBER_ADD_SHARP_BODY6">앞발</label></th>

				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_SHARP_BODY" id="PET_MEMBER_ADD_SHARP_BODY7"
					value="7" /></th>
				<th style="font-size: 1.1em; padding: 0.3em; width: 8em;"><label
					for="PET_MEMBER_ADD_SHARP_BODY7">뒷발</label></th>

				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_SHARP_BODY" id="PET_MEMBER_ADD_SHARP_BODY8"
					value="8" /></th>
				<th style="font-size: 1.1em; padding: 0.3em; width: 8em;"><label
		...
		<table
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_ATTACK" id="PET_MEMBER_ADD_ATTACK1" value="1" />
				</th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_ATTACK" id="PET_MEMBER_ADD_ATTACK2" value="2" />
				</th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
		...
		<table
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_VACCINATION" id="PET_MEMBER_ADD_VACCINATION1"
					value="1" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
			...
			<tr>
				<th style="width: 2em; padding-left: 1em;"><input type="radio"
					name="PET_MEMBER_ADD_VACCINATION" id="PET_MEMBER_ADD_VACCINATION2"
					value="2" /></th>
				<th style="font-size: 1.1em; padding: 0.3em;"><label
