					...
					<table
						...
						<tr style="height: 4em;">
							...
							<td style="width: 18.75%;" align="right">
								<span style="font-size: 1.2em; margin-right: 2em;"><b>이용횟수</b></span>
							</td>
							<td style="width: 18.75%;">
								<span style="font-size: 1.1em; margin-left: 1em;">${row.USE_TIME}</span>
							</td>
						</tr>
					</table>
				</c:forEach>
	...
	<div align="center" style="position: relative; margin-top: 2em; margin-bottom: 10em;">
		<div style="text-align: center; position: relative; width: auto">
			...
			<button style="width: 13em; height: 3em; font-size: 1.2em;" id="modify"
				class="my_button" onclick="location.href = 'memDeleteAdmin?type=${map.MEMBER_DIVISION}&&id=${map.MEM_ID}&&pass=${map.PASSWORD1}'">탈&nbsp;&nbsp;&nbsp;&nbsp;퇴</button>
		</div>
	</div>
</body>
