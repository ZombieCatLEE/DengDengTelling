	...
	<div class="table">
		<form>
			<table style="width: 100%">
				...
				<tbody>
					<c:choose>
						<c:when test="${fn:length(adminNoticeList) > 0}">
							<c:forEach items="${adminNoticeList }" var="row" begin="0"
							...
							<tr>
								...
								<td colspan="2" align="left"><input type="submit"
									...
									value="검색"></td>
								<td>
									<button type="button" onclick="write()">글작성</button>
								</td>
							</tr>
						</c:when>
						<c:otherwise>
							...
							<tr>
								...
								<td colspan="2" align="left"><input type="submit"
									...
									value="검색"></td>
								<td>
									<button type="submit" id="write">글작성</button>
								</td>
							</tr>
						</c:otherwise>
					</c:choose>
